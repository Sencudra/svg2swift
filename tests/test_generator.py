...
from sources.ui_bezier_path_generator import UIBezierPathGenerator
...
class TestGenerator:
    ...
    def test_generate_move_to_absolute(self):
        # Given
        command = (1.0, 2.0)
        self.generator._UIBezierPathGenerator__current_pos = [0.0, 0.0]

        # When
        result = self.generator._UIBezierPathGenerator__generate_move_to(command, coords='absolute')
    ...
    def test_generate_line_to_absolute(self):
        ...
        # When
        result = self.generator._UIBezierPathGenerator__generate_line_to(command, coords='absolute')
    ...
    def test_generate_line_to_h_absolute(self):
        ...
        # When
        result = self.generator._UIBezierPathGenerator__generate_horizontal_line_to(command, coords='absolute')
    ...
    def test_generate_line_to_v_absolute(self):
        ...
        # When
        result = self.generator._UIBezierPathGenerator__generate_vertical_line_to(command, coords='absolute')
    ...
    def test_generate_cubic_curve_absolute(self):
        ...
        # When
        result = self.generator._UIBezierPathGenerator__generate_cubic_curve(command, coords='absolute')
    ...
    def test_generate_cubic_curve_relative(self):
        ...
        # When
        result = self.generator._UIBezierPathGenerator__generate_cubic_curve(command, coords='relative')
    ...
    def test_generate_cubic_smooth_curve_absolute(self):
        ...
        self.generator._UIBezierPathGenerator__current_pos = [26.0, -32.0]
        self.generator._UIBezierPathGenerator__last_cubic_control_point = [-2.0, -32.0]

        # When
        result = self.generator._UIBezierPathGenerator__generate_cubic_smooth_curve(command, coords='absolute')
    ...
    def test_generate_cubic_smooth_curve_relative(self):
        ...
        # When
        result = self.generator._UIBezierPathGenerator__generate_cubic_smooth_curve(command, coords='relative')
    ...
    def test_generate_quadratic_curve_absolute(self):
        ...
        # When
        result = self.generator._UIBezierPathGenerator__generate_quadratic_curve(command, coords='absolute')
    ...
    def test_generate_quadratic_curve_relative(self):
        # Given
        command = (1.0, -2.0, -3.0, 4.0)
        self.generator._UIBezierPathGenerator__current_pos = [1.0, -2.0]

        # When
        result = self.generator._UIBezierPathGenerator__generate_quadratic_curve(command, coords='relative')
    ...
    def test_generate_quadratic_smooth_curve_absolute(self):
        # Given
        command = (1.0, -2.0)
        self.generator._UIBezierPathGenerator__current_pos = [1.0, 4.0]
        self.generator._UIBezierPathGenerator__last_quadratic_control_point = [2.0, -4.0]

        # When
        result = self.generator._UIBezierPathGenerator__generate_quadratic_smooth_curve(command, coords='absolute')
    ...
    def test_generate_quadratic_smooth_curve_relative(self):
        ...
        # When
        result = self.generator._UIBezierPathGenerator__generate_quadratic_smooth_curve(command, coords='relative')
